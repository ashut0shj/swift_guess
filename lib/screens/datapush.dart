...
Future<void> uploadSongsToFirebase() async {
  ...
  // Your songs data - add all your Taylor Swift songs here
  ...
  for (var entry in songs.entries) {
    try {
      await firestore.collection('taylor_swift_songs').add({
        'name': entry.key,
        'hint': entry.value,
      });
      print('Added song: ${entry.key}');
    } catch (e) {
      print('Error adding ${entry.key}: $e');
    }
  }
