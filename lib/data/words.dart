...
class SongData {
  // Dictionary of songs with their hints
  static const Map<String, String> songDictionary = {
    ...
    // Additional fan favorites with only alphabets
  ...
  static List<String> get taylorSwiftSongs => songDictionary.keys.toList();
}
